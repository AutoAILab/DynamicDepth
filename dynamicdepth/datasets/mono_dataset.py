...
class MonoDataset(data.Dataset):
    ...
    def preprocess(self, inputs, color_aug):
        ...
        if self.mask_noise:
            ...
            if type(self).__name__ in ["CityscapesPreprocessedDataset", "CityscapesEvalDataset", "KITTIRAWDataset"]:
    ...
    def __getitem__(self, index):
        ...
        if type(self).__name__ in ["CityscapesPreprocessedDataset", "CityscapesEvalDataset", \
                                   "CityscapesInstaDMDataset", "CityscapesInstaDMEvalDataset"]:
            ...
            if self.feat_warp:
                inputs.update(self.get_warp(folder, frame_index, side, do_flip))
        else:
            inputs.update(self.get_doj_mask(folder, frame_index, side, do_flip))
